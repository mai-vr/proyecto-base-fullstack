...
Para poder visualizar el proyecto, primeramente hay que clonarlo desde github, para eso se puede utilizar en la terminal local:
```
git clone https://github.com/mai-vr/proyecto-base-fullstack.git
```
Luego, hay que abrir index.html en cualquier navegador. Para esto, es necesario posicionarse sobre el archivo, hacer click derecho, seleccionar la opcion 'Open with' y elegir el navegador.
